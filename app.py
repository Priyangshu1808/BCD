...
st.write("Predict whether a tumor is **Malignant** or **Benign** using ML models")
...
# -----------------------------------------------------
st.markdown("---")
st.markdown("**ML Pipeline Models:** Decision Tree, Logistic Regression, KNN, SVM, Naive Bayes, Random Forest")